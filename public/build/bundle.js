...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			set_style(div, "transform", "rotate(" + /*i*/ ctx[2] * 30 + "deg)");
    			set_style(div, "animation-delay", -1.2 + /*i*/ ctx[2] * 0.1 + "s");
    			attr_dev(div, "class", "svelte-fthgfe");
    			add_location(div, file$1, 3, 4, 82);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(3:2) {#each Array(12) as _, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "lds-spinner svelte-fthgfe");
    			add_location(div, file$1, 1, 0, 24);
    		},
