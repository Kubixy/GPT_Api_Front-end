...
var app = (function () {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	let t0_value = (/*message*/ ctx[5].role === "user"
    	? "You: "
    	: "Assistant: ") + "";

    	let t0;
    	let t1;
    	let t2_value = /*message*/ ctx[5].content + "";
    	let t2;
    	let t3;
    	let div_class_value;
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*messages*/ 2 && t0_value !== (t0_value = (/*message*/ ctx[5].role === "user"
    			? "You: "
    			: "Assistant: ") + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*messages*/ 2 && t2_value !== (t2_value = /*message*/ ctx[5].content + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*messages*/ 2 && div_class_value !== (div_class_value = "message " + /*message*/ ctx[5].role)) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [prompt, messages, generateText, textarea_input_handler];
    }
